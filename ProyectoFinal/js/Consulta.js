document.getElementById('consultar-Usuario').addEventListener('click',async(e)=>{
    e.preventDefault()
    const form = new FormData(document.getElementById('Form-Usuario'))
    const results = await fetch('./consultas/Consulta.php',{
        method:'POST',
        body: form
    })
    results.status==200?
